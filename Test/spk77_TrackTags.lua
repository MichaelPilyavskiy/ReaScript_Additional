...
function init()
  ...
  gfx.init(script.title, conf.wind_w, conf.wind_h, conf.dock, conf.wind_x, conf.wind_y)
  ...
  ---------------------------------------------------
  function MPL_HasWindXYWHChanged()
  ...
  ---------------------------------------------------
  function MPL_ExtState_Save(conf)
  ...
  ---------------------------------------------------
  function MPL_ExtState_Load(conf)
...
function mainloop()
  local ret =  MPL_HasWindXYWHChanged() 
  if ret > 0  then  MPL_ExtState_Save(conf)  end
